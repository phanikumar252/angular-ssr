...
// Slick Job carousel VINJS

$('.jobs').slick({
	slidesToShow: 2,
	prevArrow:'<span class="slide prevArrow"><i class="fa fa-chevron-circle-left"></span>',
	nextArrow:'<span class="slide nextArrow"><i class="fa fa-chevron-circle-right"></span>',
	responsive: [
		{
...
// Stick Job Description VINJS
$(document).scroll(function() {
    var y = $(document).scrollTop(), //get page y value 
        header = $("#jobdesc"); // your div id
        // console.log(y);
    if(y >= 150)  {
